                            ...
                            <div class="drop-down dropdown-profile   dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li><a href="page-login.html"onclick="event.preventDefault(); document.getElementById('keluar-app').submit();"><i class="icon-key"></i> <span>Logout</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
...
<div class="nk-sidebar">           
    <div class="nk-nav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="{{ route('home') }}" class="icon-home menu-icon">
                    <span class="nav-text">Beranda</span>
                </a>
            </li>
            <li>
                <a href="{{ url('user') }}" class="icon-user menu-icon">
                    <span class="nav-text">User</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="{{ url('anggota') }}" class="icon-people menu-icon">
...
***********************************-->
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="{{ asset('backend/https://themeforest.net/user/quixlab') }}">Quixlab</a> 2018</p>
            </div>
        </div>
        <!--**********************************
            Footer end
